...
from exp.exp_main_pre import Exp_Main_Pre
import random
import numpy as np
...
def main():
    ...
    parser.add_argument('--target', type=str, default='EpochData', help='target feature in S or MS task')
    ...
    parser.add_argument('--units', type=int, default=40, metavar='N', help='dimension of attention layers (default: 128)')
    parser.add_argument('--ranks', type=int, default=1700, metavar='N', help='dimension of attention layers (default: 128)')
    parser.add_argument('--n_heads', type=int, default=8, help='num of heads')
    parser.add_argument('--score_factor', type=int, default=2, metavar='N', help='number of layers (default: 2)')
    parser.add_argument('--stride_e', type=int, default=2, metavar='N', help='number of stride for MaxPool (default: 10)')
    parser.add_argument('--stride_d', type=int, default=2, metavar='N', help='number of stride for MaxPool (default: 10)')
    parser.add_argument('--stride_u', type=int, default=2, metavar='N', help='number of stride for MaxPool (default: 10)')
    parser.add_argument('--stride_g', type=int, default=5, metavar='N', help='number of stride for MaxPool (default: 10)')
    ...
    parser.add_argument('--input_dim', type=int, default=1, help='input/output size')
    parser.add_argument('--d_model', type=int, default=512, help='dimension of model')
    parser.add_argument('--e_layers', type=int, default=1, help='num of encoder layers')
    parser.add_argument('--g_layers', type=int, default=1, help='num of decoder layers')
    parser.add_argument('--d_layers', type=int, default=1, help='num of decoder layers')
    parser.add_argument('--u_layers', type=int, default=1, help='num of decoder layers')
    parser.add_argument('--num_layers', type=int, default=1, help='num of decoder layers')
    parser.add_argument('--d_ff', type=int, default=512*2, help='dimension of fcn')
    ...
    parser.add_argument('--output_stoken', action='store_true', help='whether to output stoken in encoder')
    ...
    parser.add_argument('--prepatience', type=int, default=5, help='early stopping patience')
    parser.add_argument('--learning_rate', type=float, default=0.0001, help='optimizer learning rate')
    parser.add_argument('--pretrain_learning_rate', type=float, default=0.0001, help='optimizer learning rate')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            setting = '{}_{}_{}_ft{}_sl{}_ll{}_pl{}_dm{}_nh{}_el{}_dl{}_df{}_fc{}_eb{}_dt{}_{}_{}'.format(
                ...
                args.des, ii)
            # # ## pretraining
            exp_pre = Exp_Pre(args,setting)  # set experiments
            print('>>>>>>>start pretraining : {}>>>>>>>>>>>>>>>>>>>>>>>>>>'.format(setting))
            exp_pre.pretrain(setting)
            ##training
